...
git clone --depth=1 https://github.com/reaPeR1010/AnyKernel3 AnyKernel
echo "Done"
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 NexusKernel-Lite-lavender-${TANGGAL}.zip *
    cd ..
}
sticker
sendinfo
